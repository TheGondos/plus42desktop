...
static int ext_eqn_cat[] = {
    CMD_COMP,   CMD_DIRECT,  CMD_EQN_T, CMD_EQNINT, CMD_EQNMENU, CMD_EQNMNU1,
    CMD_EQNSLV, CMD_EQNVAR,  CMD_EVAL,  CMD_EVALN,  CMD_NUMERIC, CMD_PARSE,
    CMD_STD,    CMD_UNPARSE, CMD_NULL,  CMD_NULL,   CMD_NULL,    CMD_NULL
};
...
static int ext_misc_cat[] = {
    ...
    CMD_RCOMPLX, CMD_SPFV,    CMD_SPPV,  CMD_STRACE, CMD_TVM,     CMD_USFV,
    CMD_USPV,    CMD_X2LINE,  CMD_ACCEL, CMD_LOCAT,  CMD_HEADING, CMD_FPTEST
};
...
static int ext_misc_cat[] = {
    CMD_A2LINE,  CMD_A2PLINE, CMD_FMA,   CMD_LINE,   CMD_PCOMPLX, CMD_PLOT_M,
    CMD_RCOMPLX, CMD_SPFV,    CMD_SPPV,  CMD_STRACE, CMD_TVM,     CMD_USFV,
    CMD_USPV,    CMD_X2LINE,  CMD_ACCEL, CMD_LOCAT,  CMD_HEADING, CMD_NULL
};
#define MISC_CAT_ROWS 3
#endif
#else
...
static int ext_misc_cat[] = {
    CMD_A2LINE,  CMD_A2PLINE, CMD_FMA,    CMD_LINE,   CMD_PCOMPLX, CMD_PLOT_M,
    CMD_RCOMPLX, CMD_SPFV,    CMD_SPPV,   CMD_STRACE, CMD_TVM,     CMD_USFV,
    CMD_USPV,    CMD_X2LINE,  CMD_FPTEST, CMD_NULL,   CMD_NULL,    CMD_NULL
};
#define MISC_CAT_ROWS 3
#else
static int ext_misc_cat[] = {
    CMD_A2LINE,  CMD_A2PLINE, CMD_FMA,  CMD_LINE,   CMD_PCOMPLX, CMD_PLOT_M,
    CMD_RCOMPLX, CMD_SPFV,    CMD_SPPV, CMD_STRACE, CMD_TVM,     CMD_USFV,
    CMD_USPV,    CMD_X2LINE,  CMD_NULL, CMD_NULL,   CMD_NULL,    CMD_NULL
};
#define MISC_CAT_ROWS 3
#endif
#endif
